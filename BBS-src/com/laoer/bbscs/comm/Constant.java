...
public class Constant {
	...
	public static long[] BOARD_PERMISSION_GROUP_2 = { 401, 402, 403, 404, 405, 406, 408, 409, 410, 414, 415, 416, 420,
			421, 422, 423, 424, 425, 426, 427, 430, 431, 432, 433, 434, 435, 440, 441, 450, 460 };

	public static long[] BOARD_PERMISSION_GROUP_3 = { 401, 402, 403, 405, 406, 408, 409, 410, 414, 426, 427, 435, 440,
			450 };

	public static long[] BOARD_PERMISSION_GROUP_4 = { 401, 402, 403, 404, 405, 406, 407, 408, 409, 410, 411, 412, 413,
			414, 415, 416, 420, 421, 422, 423, 424, 425, 426, 427, 430, 431, 432, 433, 434, 435, 440, 441, 450, 451,
			460, 462, 463, 464, 465, 466, 601, 602, 603, 604, 608, 609, 610 };

	public static long[] BOARD_PERMISSION_GROUP_5 = { 401, 402, 403, 404, 405, 406, 407, 408, 409, 410, 411, 412, 413,
			414, 415, 416, 420, 421, 422, 423, 424, 425, 426, 427, 430, 431, 432, 433, 434, 435, 440, 441, 450, 451,
			460, 462, 463, 464, 465, 466, 470, 471, 475, 601, 602, 603, 604, 605, 606, 607, 608, 609, 610, 611 };
	...
	public static String[] TITLECOLOR = { "", "#990000", "#006600", "#666600", "#000066", "#660066", "#008080",
			"#808080", "#CCCCCC", "#FF0000", "#00FF00", "#FFFF00", "#0000FF", "#FF00FF", "#00FFFF" };

	public static String[][] TIMEZONEVALUES = { { "(GMT -12:00) Eniwetok, Kwajalein", "GMT-12:00" },
			{ "(GMT -11:00) Midway Island, Samoa", "GMT-11:00" }, { "(GMT -10:00) Hawaii", "GMT-10:00" },
			{ "(GMT -09:00) Alaska", "GMT-09:00" }, { "(GMT -08:00) Pacific Time", "GMT-08:00" },
			{ "(GMT -07:00) Mountain Time", "GMT-07:00" }, { "(GMT -06:00) Central Time", "GMT-06:00" },
			{ "(GMT -05:00) Eastern Time", "GMT-05:00" }, { "(GMT -04:00) Atlantic Time", "GMT-04:00" },
			{ "(GMT -03:30) Newfoundland", "GMT-03:30" }, { "(GMT -03:00) Brassila, Buenos Aires", "GMT-03:00" },
			{ "(GMT -02:00) Mid-Atlantic", "GMT-02:00" }, { "(GMT -01:00) Azores, Cape Verde Islands", "GMT-01:00" },
			{ "(GMT) Casablanca, Dublin, London", "GMT" },
			{ "(GMT +01:00) Amsterdam, Berlin,Paris, Rome", "GMT+01:00" },
			{ "(GMT +02:00) Cairo, Helsinki", "GMT+02:00" }, { "(GMT +03:00) Baghdad, Moscow, Nairobi", "GMT+03:00" },
			{ "(GMT +03:30) Tehran", "GMT+03:30" }, { "(GMT +04:00) Abu Dhabi, Baku", "GMT+04:00" },
			{ "(GMT +04:30) Kabul", "GMT+04:30" }, { "(GMT +05:00) Ekaterinburg, Islamabad", "GMT+05:00" },
			{ "(GMT +05:30) Bombay, Calcutta", "GMT+05:30" }, { "(GMT +05:45) Katmandu", "GMT+05:45" },
			{ "(GMT +06:00) Almaty, Colombo", "GMT+06:00" }, { "(GMT +06:30) Rangoon", "GMT+06:30" },
			{ "(GMT +07:00) Bangkok, Hanoi, Jakarta", "GMT+07:00" },
			{ "(GMT +08:00) Beijing, Hong Kong, Perth", "GMT+08:00" },
			{ "(GMT +09:00) Osaka, Sapporo, Tokyo", "GMT+09:00" }, { "(GMT +09:30) Adelaide, Darwin", "GMT+09:30" },
			{ "(GMT +10:00) Canberra, Guam", "GMT+10:00" }, { "(GMT +11:00) Magadan, New Caledonia", "GMT+11:00" },
