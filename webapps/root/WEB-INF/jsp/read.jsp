...
<div id="main">
  ...
  <div id="head2">
    <div id="head2content">
    <s:text name="read.thisposturl"/>:<span id="posturl" class="font6"><bbscs:topic type="posturl"/></span>
    </div>
  </div>
  <div id="content">
    <div id="postlist">
      ...
      <s:iterator id="f" value="%{pageList.objectList}" status="rowstatus">
        <div class="topicdiv" id="topic<s:property value="#f.id"/>">
        ...
        <div id="qpostdiv" class="topicdiv">
          ...
          <td class="bgColor5">
            <table width="100%" border="0" cellpadding="4" cellspacing="1">
                ...
                <tr>
                  ...
                  <td class="bgColor4">
                    <textarea name="detail" cols="80" rows="10" class="textarea1" onkeyup="javascript:return ctrlEnter(event);"></textarea>
                  </td>
                </tr>
                <tr>
    ...
    <div id="siderbar">
      <div id="siderbarcontent">
        <div class="siderbartitle" id="searchtitle"><s:text name="forum.searchall"/></div>
        <div class="siderbarcontent" id="searchdiv">
        ...
        <div class="siderbartitle" id="commendtitle"><s:text name="forum.commendtitle"/></div>
		<div class="siderbarcontent" id="commenddiv">
		<bbscs:topic type="commend"/>
		</div>
		<div class="siderbarcontent" id="adv3">
		<div align="center">
